...
<head>
    ...
    <title>About - PSAU Property Management System</title>
...
<main class="page">
    ...
    <div class="hero reveal">
        ...
        <h1 class="hero-title">Property Management<br>System</h1>
    ...
    <div class="card reveal">
        ...
        <div class="card-body">
            <p class="overview-text">
                The <strong>PSAU Property Management System</strong> is a comprehensive digital solution designed to streamline the management, tracking, and monitoring of university properties and assets. It ensures <strong>efficient property inventory</strong>, enhanced asset tracking, and improved accountability — fully aligned with PSAU's digital transformation initiatives and asset management policies.
            </p>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="feature-grid">
                <div class="feature-item">
                    ...
                    <div class="feature-name">Property Management</div>
                    <div class="feature-desc">Registration, tracking, and inventory of all university properties</div>
                </div>
                <div class="feature-item">
                    <span class="feature-icon">👥</span>
                ...
                <div class="feature-item">
                    <span class="feature-icon">📊</span>
                    <div class="feature-name">Asset Monitoring</div>
                    <div class="feature-desc">Real-time tracking of property status and condition</div>
                </div>
                <div class="feature-item">
                    <span class="feature-icon">🔍</span>
                    <div class="feature-name">Advanced Search</div>
                    <div class="feature-desc">Smart filters for quick and efficient property retrieval</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card reveal">
        ...
        <div class="card-body">
            <p class="overview-text" style="margin-bottom: 18px;">
                Built with modern web technologies ensuring a reliable, secure, and maintainable platform for the university's property management operations.
            </p>
            <div class="tag-list">
    ...
    <div class="footer reveal">
        <div class="footer-inner">
            ...
            <p class="footer-copy">
                ...
                Management Information System Unit &nbsp;·&nbsp; Property Management System
            </p>
        </div>
    </div>
